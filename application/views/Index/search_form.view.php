...
<form name="Search" action="<?php echo Functions::pageLink('Index','Search');?>" method="POST">
    ...
    <div class=" grid_mob_6 grid_med_3">
        <div class="field searchfield">
            ...
            <label for="q">Search Events/Teams</label>
    ...
    <div class=" grid_mob_6 grid_med_3">
        <div class="field searchfield">
            ...
            <input type="date" name="fromDate" id="fromDate" value="<?php echo htmlentities(strip_tags($_POST['fromDate']));?>">
        </div>
    </div>
    <div class=" grid_mob_6 grid_med_3">
        <div class="field searchfield">
            ...
            <input type="date" name="toDate" id="toDate" value="<?php echo htmlentities(strip_tags($_POST['toDate']));?>">
        </div>
    </div>
